...
BOOST_PYTHON_MODULE(Subscription)
{
    py::class_<core::Subscription>(
        ...
        .def("add_message", &core::Subscription::add_message, "Add a message to the subscription.")
        .def(
            "get_messages", (core::MessageContainerType(core::Subscription::*)()) & core::Subscription::get_messages, "Get all messages.")
        .def(
            "get_messages", (core::MessageContainerType(core::Subscription::*)()) & core::Subscription::get_messages,
            "Get all messages.");
}
*/
