...
//{
///**
// * @brief The ModelExecutor class is a definition of an executor that runs the uploaded model on the specified
// backend.
// */
//    class ModelExecutor
//    {
...
//         */
//        ModelExecutor(knp::framework::Model &model, const std::filesystem::path &backend_path, InputChannelMap
//        i_map)
...
//        /**
//         * @brief Get reference to input channel by iGhbts UID.
//         * @note Constant method.
//         * @param channel_uid channel UID.
//         * @return reference to input channel.
//         * @throw std::runtime_error if no channel with the given UID exists.
...
//        void add_observer(monitoring::MessageProcessor<Message> &&message_processor, const std::vector<core::UID>
//        &senders)
//        {
//            observers_.emplace_back(monitoring::MessageObserver<Message>(
//                    backend_->get_message_bus().create_endpoint(), std::move(message_processor),
//                    core::UID{true}));
//
...
//        void init_channels(
//                const std::unordered_multimap<core::UID, core::UID, core::uid_hash> &channels, GenType
//                channel_gen);
//
