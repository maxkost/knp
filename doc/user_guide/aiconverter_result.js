...
Page[36]=new Array("Этот раздел содержит информацию об общих библиотеках, форматах данных и структуры нейронной сети, используемых Kaspersky Neuromorphic Platform.","Общие библиотеки и форматы","235594.htm");
Page[37]=new Array("Kaspersky Neuromorphic Platform использует следующие библиотеки:","Boost.&nbsp;Библиотеки используются для реализации классов и структур&nbsp;(например, UID, BackendLoader).","FlatBuffers. Библиотека используется для сериализации в Kaspersky Neuromorphic Platform.","GoogleTest. Библиотека используется для тестов платформы.","Intel PCM. Библиотека используется для получения от CPU метаданных устройства&nbsp;(например, данные об энергопотреблении).","PyBind11. Библиотека используется для предоставления доступа в Python-фреймворке к функциям и классам, реализованным в библиотеках C++.","spdlog. Библиотека используется для логирования работы Kaspersky Neuromorphic Platform.","Общие библиотеки","235876.htm");
